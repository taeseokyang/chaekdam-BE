package eggis0.baram.domain2.council_item.presentation;

import eggis0.baram.domain2.council_item.dto.req.UpdateCouncilItemRequest;
import eggis0.baram.domain2.council_item.application.CouncilItemService;
import eggis0.baram.domain2.council_item.domain.CouncilItem;
import eggis0.baram.domain2.council_item.dto.req.AddCouncilItemRequest;
import eggis0.baram.domain2.council_item.dto.res.CouncilItemResponse;
